...
// Define the ad-specific code blocks outside the component for clarity.
// =======================================================================

// 1. POPUNDER SCRIPT (Zone ID: 5731792) - Full inline script from ExoClick
  ...
  return (
    <html lang="en">
      <body>
        ...
        {/* All ad code is placed at the very end of the body for guaranteed execution. */}
        {/* ======================================================= */}

        {/* 1. POPUNDER ZONE (ID: 5731792) */}
        <script
          type="application/javascript"
          // Must use dangerouslySetInnerHTML to correctly inject the large inline script
